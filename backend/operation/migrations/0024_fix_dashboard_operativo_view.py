# Generated migration to fix dashboard operativo view to include all order statuses
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('operation', '0023_create_dashboard_operativo_view'),
    ]

    operations = [
        # Drop existing view and recreate with all orders
        migrations.RunSQL(
        ...
        migrations.RunSQL(
            ...
            -- INCLUIR TODAS LAS ÓRDENES para obtener todos los estados de items
            -- El filtrado por fecha se hace en el backend
