...
const PaymentHistory = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">PaymentHistory - Historial de Pagos</h1>
        <p className="text-sm text-gray-600 mt-1">Revisa y gestiona los pagos procesados</p>
      </div>
