...
const ZoneModal = ({ isOpen, onClose, zone = null, onSave }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (zone?.id) {
        await apiService.zones.update(zone.id, zoneData);
        showSuccess('Zona actualizada exitosamente');
      } else {
        await apiService.zones.create(zoneData);
      ...
      showError('Error al guardar la zona: ' + errorMessage);
    } finally {
      setLoading(false);
    }
  };
