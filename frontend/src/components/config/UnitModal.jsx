...
const UnitModal = ({ isOpen, onClose, unit = null, onSave }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (unit?.id) {
        await apiService.units.update(unit.id, unitData);
        showSuccess('Unidad actualizada exitosamente');
      } else {
        await apiService.units.create(unitData);
      ...
      showError('Error al guardar la unidad: ' + errorMessage);
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="Ej: kg, litros, piezas, gramos"
