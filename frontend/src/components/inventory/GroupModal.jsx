...
const GroupModal = ({ isOpen, onClose, group = null, onSave }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (group?.id) {
        await apiService.groups.update(group.id, groupData);
        showSuccess('Grupo actualizado exitosamente');
      } else {
        await apiService.groups.create(groupData);
      ...
      showError('Error al guardar el grupo: ' + errorMessage);
    } finally {
      setLoading(false);
    }
  };
