...
# Clean old backups (keep only 3 most recent) - non-critical
...
# Clean temp files - non-critical cleanup
echo "🗑️ Cleaning temp files..."
/bin/rm -rf /tmp/migration* /tmp/simple-deploy* /tmp/auto-cleanup* 2>/dev/null || true
...
# Clean Python cache - non-critical  
